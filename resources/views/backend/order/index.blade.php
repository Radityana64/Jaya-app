...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="manajemen-pesanan m-0 font-weight-bold text-primary">Daftar Pesanan</h6>
    </div>
    <div class="card-body master-pesanan">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async function() {
        ...
        async function fetchOrders() {
            const url = `${getApiBaseUrl()}/api/pemesanan/data/master`;
            try {
        ...
        function searchOrders(query) {
            ...
            const filteredOrders = allOrders.filter(order => {
                ...
                const pelangganMatch = order.nama_pelanggan.toLowerCase().includes(query)
                
                return idMatch || productMatch || pelangganMatch;
            });
        ...
        function renderOrders(status = "Semua", filteredOrders = null) {
            ...
            let ordersToRender = filteredOrders ? filteredOrders : allOrders.filter(order => {
            ...
            ordersToRender.forEach(order => {
                ...
                orderItem.innerHTML = `
                    <div class="d-flex justify-content-between">
                        <p>Pesanan #${order.id_pemesanan} ${order.nama_pelanggan}</p>
                        <div class="d-flex"> 
            ...
            document.querySelectorAll(".show-details-btn").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    const order = allOrders.find(o => o.id_pemesanan == orderId);
                ...
                <div class="row mb-4 border-bottom pb-3">
                    <div class="col-6 border-right pb-3">
                        ...
                        <p class="mb-1"><strong>No. Telepon:</strong> 
                            <a href="${formatWhatsAppLink(order.telepon)|| "-"}" 
                                class="whatsapp-link" target="_blank"><i class="fab fa-whatsapp"></i> +${order.telepon}
                            </a>
                        </p>
